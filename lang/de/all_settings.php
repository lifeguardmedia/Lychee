...
return [
    ...
    */
        ...
        'sm_twitter_url' => 'URL des X-Profils (ehem. Twitter)',
        'sm_instagram_url' => 'URL des Instagram-Profils',
        'sm_youtube_url' => 'URL des Youtube-Profils',
        'thumb_2x' => '2-fache Größe der quadratischen Miniaturansichten aktivieren',
        'small_2x' => '2-fache Größe kleiner Miniaturansichten aktivieren',
        'medium_2x' => '2-fache Größe mittlerer Bilder aktivieren',
        'site_title' => 'Website Titel',
        'footer_show_copyright' => 'Copyright in der Fußzeile anzeigen.',
        'site_copyright_begin' => 'Erstes Jahr des Urheberrechts',
        'site_copyright_end' => 'Letztes Jahr des Urheberrechts',
        'allow_online_git_pull' => 'Git-Pull über die Weboberfläche zulassen',
       ...
       'search_public' => 'Anonymen Benutzern die Nutzung der Suchleiste erlauben',
        'hide_version_number' => 'Aktuelle Versionsnummer ausblenden',
        'recent_age' => 'Maximales Alter der Fotos im Bereich „Neueste“ (in Tagen)',
        'grants_download' => 'Download standardmäßig erlauben.',
        'photos_wraparound' => 'Nach dem letzten Foto eines Albums wieder zum Anfang springen',
        'raw_formats' => 'Zusätzliche erlaubte Formate, die nicht verarbeitet werden',
        'map_display' => 'Karte anzeigen, wenn GPS-Koordinaten vorhanden sind',
        'zip64' => 'Zip64 (64 Bit) statt 32 Bit verwenden',
        'map_display_public' => 'Anonymen Benutzern den Zugriff auf die Karte erlauben',
        'map_provider' => 'Definiert den Kartenanbieter',
        'map_include_subalbums' => 'Fotos aus Unteralben auf der Karte einbeziehen',
        'update_check_every_days' => 'Häufigkeit der Lychee-Aktualisierungsprüfung',
        'has_exiftool' => 'Gibt an, ob ExifTool-Verarbeitung verfügbar ist',
        'share_button_visible' => 'Sichtbarkeit der Teilen-Schaltfläche im Header',
        'has_ffmpeg' => 'Gibt an, ob FFmpeg-Verarbeitung verfügbar ist',
        'import_via_symlink' => 'Beim Import vom Server symbolische Links statt Kopieren verwenden',
        'apply_composer_update' => 'Composer-Update beim Lychee-Update über die Weboberfläche durchführen',
        'location_decoding' => 'GPS-Ortsauflösung verwenden',
        'location_decoding_timeout' => 'Timeout für GPS-Ortsauflösungsanfragen',
        'location_show' => 'Aus GPS-Daten extrahierten Standort anzeigen',
        'location_show_public' => 'Anonyme Benutzer dürfen den extrahierten Standort sehen',
        'rss_enable' => 'RSS-Feed aktivieren',
        'rss_recent_days' => 'Letzte X Tage im RSS-Feed anzeigen',
        'rss_max_items' => 'Maximale Anzahl an Einträgen im RSS-Feed',
        'prefer_available_xmp_metadata' => 'XMP-Sidecar-Dateien gegenüber EXIF-Daten bevorzugen',
        'editor_enabled' => 'Manuelle Bildrotation aktivieren',
        'lossless_optimization' => 'Zusätzliche verlustfreie Bildkompression anwenden',
        'local_takestamp_video_formats' => 'Lokalen Zeitstempel für folgende Videoformate verwenden',
        'log_max_num_line' => 'Letzte X Logzeilen anzeigen',
        'unlock_password_photos_with_url_param' => 'Passwort per URL-Parameter zum Entsperren von Alben erlauben',
    ...
    'details' => [
        ...
        'imagick' => '',
        'dropbox_key' => 'Verwende den Wert „disabled“, um diese Einstellung zu deaktivieren.',
        'skip_duplicates' => '',
        'lang' => '',
        'default_license' => '',
        'small_max_width' => '',
        ...
        'delete_imported' => '',
        'mod_frame_enabled' =>'Hinweis: Für die Anzeige des Rahmens ist Zugriff auf das gewählte Album erforderlich.<br><i class="pi pi-exclamation-triangle text-orange-500"></i>Die Schaltfläche wird nur angezeigt, wenn die Bedingung erfüllt ist.',
        'mod_frame_refresh' => '',
        'image_overlay_type' => '',
        'compression_quality' => '',
        'landing_page_enable' => '',
        ...
        'footer_additional_text' => '<span class="pi pi-exclamation-triangle text-orange-500"></span> Nicht bereinigtes HTML-Feld.',
        ...
        'nsfw_visible' => '',
        'nsfw_blur' => 'Albumtitelbild weichzeichnen.',
        'nsfw_warning' => 'Beim ersten Öffnen des Albums eine Warnung anzeigen.',
        'nsfw_warning_admin' => '',
        ...
        'zip_deflate_level' =>'-1 = Kompression deaktivieren (STORE-Methode), 0 = keine Kompression (DEFLATE), 1 = minimale Kompression (schnell), … 9 = maximale Kompression (langsam)',
        ...
        'random_album_id' =>'Standardalbum, das angezeigt wird. Wenn leer, werden alle durchsuchbaren Fotos verwendet.',,
        ...
        'keep_original_untouched' =>'Bei automatischer Rotation bleibt das Originalbild unverändert.',
